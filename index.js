...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.t1ods8h.mongodb.net/?appName=Cluster0`;
...
app.get('/', (req, res) => {
    res.send('tours-server is running')
})

app.listen(port, () => {
    console.log(`tours-server is running on port ${port}`)
})